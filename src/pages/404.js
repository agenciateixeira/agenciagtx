...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      >
        {/* Logo */}
        <a href="/" className="inline-flex items-center mb-12">
          <Image
            src="/images/logo.png"
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a
            href={`https://wa.me/5519990122773?text=${encodeURIComponent('Olá! Preciso de ajuda.')}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-white text-gray-700 border-2 border-gray-200 px-7 py-3.5 rounded-full font-semibold hover:border-green-500 hover:text-green-600 transition-all"
          >
